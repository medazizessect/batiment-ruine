...
<div class="top">
  ...
  <div class="blk" style="text-align:left">إدارة الشؤون الفنية</div>
</div>
...
<div class="card">
  <div class="r"><b>العقار الكائن بـ:</b> <?= htmlspecialchars($addressLabel ?: ($case['lieu'] ?? '')) ?></div>
  <div class="r"><b>المالك:</b> <?= htmlspecialchars(($v['owner_name'] ?? '') ?: ($case['proprietaire'] ?? '')) ?></div>
  <?php if (!empty($v['cin'])): ?><div class="r"><b>ب.ت.و:</b> <?= htmlspecialchars($v['cin']) ?></div><?php endif; ?>
  <?php if (!empty($v['occupied_by'])): ?><div class="r"><b>المشغول:</b> <?= htmlspecialchars($v['occupied_by']) ?></div><?php endif; ?>
  <?php if (!empty($v['confirmation_degree'])): ?><div class="r"><b>درجة الخطورة:</b> <?= htmlspecialchars($v['confirmation_degree']) ?></div><?php endif; ?>
  <?php if (!empty($case['commission'])): ?><div class="r"><b>اللجنة:</b> <?= htmlspecialchars($case['commission']) ?></div><?php endif; ?>
